...
import { getActiveValidatorsData, getValidatorsData } from '../../services/beaconcha/beaconcha'
import { encrypt } from '../../utils/encryptUtils'
import { wtoe } from '../../utils/numberUtils'
import { getBalances, getDepositData } from '../activateValidator'
...
import { stakingContract } from '../../globals/globalVariables'
