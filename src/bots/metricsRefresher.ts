...
export async function refreshStakingData() {
    ...
    globalStakingData.decimals = Number(await stakingContract.decimals())
    globalStakingData.name = await stakingContract.name()
    globalStakingData.rewardsFee = Number(await stakingContract.rewardsFee())
    globalStakingData.symbol = await stakingContract.symbol()
...
export async function refreshLiquidityData() {
    ...
    globalLiquidityData.name = await liquidityContract.name()
    globalLiquidityData.symbol = await liquidityContract.symbol()
    globalLiquidityData.targetLiquidity = await liquidityContract.targetLiquidity()
    globalLiquidityData.decimals = Number(await liquidityContract.decimals())
    ...
    globalLiquidityData.minFee = Number(await liquidityContract.minFee())
    globalLiquidityData.maxFee = Number(await liquidityContract.maxFee())
